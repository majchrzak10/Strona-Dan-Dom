      ...
      <div className="mx-auto w-full max-w-[1400px]">
        <div className="grid gap-6 lg:grid-cols-10 lg:gap-8 lg:items-start">
          <div className="lg:col-span-4">
            ...
            {/* Wielu klientów woli zadzwonić niż wypełniać formularz — numer wprost w sekcji kontakt */}
            <div className="mt-5">
              <p className="text-sm text-zinc-600">Wolisz zadzwonić?</p>
              <a
                href="tel:501769166"
                className="mt-1 inline-flex items-center gap-2 font-[var(--font-playfair)] text-2xl font-bold text-brand-primary transition-colors hover:text-brand-hover sm:text-3xl"
              >
                <svg
