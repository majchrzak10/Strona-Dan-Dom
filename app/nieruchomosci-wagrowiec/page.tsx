...
export default async function NieruchomosciWagrowiecPage() {
        ...
        <div className="mx-auto w-full max-w-[1600px] space-y-5">
          ...
          {cityOffers.length > 0 ? (
            <section className="rounded-2xl bg-white px-5 py-10 shadow-[0_4px_15px_rgba(0,0,0,0.05)] sm:px-10 sm:py-14 lg:px-14">
              <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-brand-primary">Oferty w Wągrowcu</p>
              <h2 className="mt-2 font-[var(--font-playfair)] text-2xl font-bold text-black sm:text-3xl">
                Aktualne nieruchomości w Wągrowcu i okolicy
              </h2>
