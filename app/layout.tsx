...
const defaultDescription = `Biuro nieruchomości Wągrowiec i Rogoźno. 30 lat doświadczenia, ${reviewStats.count} opinii ★${reviewStats.rating}. Sprzedaż, zakup i wynajem nieruchomości. Zadzwoń: 501 769 166`;
